...
\begin{theorem}[Coh$^\omega$是PTC]\label{thm:coh-ptc}
以相干空间（Girard 1987）为对象、因果线性映射（clique）为态射、clique流为流对象，Coh$^\omega$是PTC。生产性迹保持clique：每步反馈复合是线性映射的复合（clique在复合下封闭），不同时间步的输出自动相干。
\end{theorem}
