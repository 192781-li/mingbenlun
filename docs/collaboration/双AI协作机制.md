...
3. **如果有根本性分歧（比如一个说定理对，一个说定理错），不要在main上争论，各自在自己的分支上写论证，由北原慢热拍板**
...
- 可以各自保留自己的版本，由北原慢热判断哪个更好，或者融合两者
...
4. **提交给北原慢热拍板** → 把两个版本都给北原慢热，由北原慢热决定用哪个，或者融合
5. **合并到main** → 北原慢热拍板后，把最终版本合并到main

---

## 八、北原慢热的角色

- **最终拍板权**：所有根本性分歧由北原慢热决定
- **任务分配**：北原慢热可以指定谁做什么
- **质量检查**：北原慢热可以要求任何人重做
- **灵感来源**：北原慢热的哲学直觉是整个项目的灵魂
